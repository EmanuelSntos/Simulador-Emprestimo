# Simulador de Empréstimo Pessoal Interativo

Simulador simples e interativo onde o usuário ajusta o **valor desejado** e o **prazo** e recebe a simulação das **parcelas estimadas** com juros.
...
- Cálculo automático das parcelas em tempo real
